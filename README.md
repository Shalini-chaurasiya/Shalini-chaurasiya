...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=800&size=26&duration=2500&pause=600&color=C084FC&center=true&vCenter=true&multiline=false&random=false&width=750&height=70&lines=✦+Full+Stack+MERN+Developer+✦;✦+GenAI+%26+LLM+Integration+Engineer+✦;✦+Agentic+AI+%26+RAG+Systems+Builder+✦;✦+Three.js+%26+3D+Web+Experience+Creator+✦;✦+ECE+Engineer+%7C+Basti%2C+UP%2C+India+🇮🇳+✦;✦+Open+Source+Contributor+%26+Problem+Solver+✦;✦+Turning+Wild+Ideas+into+Digital+Reality+✦" alt="Typing SVG" />
</a>

<br/>

<!-- RUNNING TECH STACK — LEFT TO RIGHT SCROLL EFFECT -->
<img src="https://readme-typing-svg.demolab.com?font=Courier+Prime&weight=700&size=15&duration=60&pause=99999&color=7C3AED&center=true&vCenter=true&multiline=false&random=false&width=900&height=28&lines=◄+React+•+Next.js+•+Node.js+•+MongoDB+•+Express+•+TypeScript+•+Python+•+GenAI+•+LangChain+•+Three.js+•+Tailwind+•+Firebase+•+Vercel+•+Figma+►" alt="Running Tech Stack" />
